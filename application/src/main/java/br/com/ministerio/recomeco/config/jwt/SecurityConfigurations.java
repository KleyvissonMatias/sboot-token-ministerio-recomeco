    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST, Endpoints.ENDPOINT_LOGIN).permitAll()
                        .requestMatchers(HttpMethod.POST, Endpoints.ENDPOINT_REGISTRAR).hasRole(UserRole.ADMIN.getRole())
